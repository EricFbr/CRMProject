...
<body>
	...
	<div id="rightToolbar" style="margin: 0 auto">
		...
		<!-- <span style="margin-left: 30px"><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-lock" plain="false" onclick="javascript:queryRirhts()" style="height: 32px">&nbsp;绑定权限&nbsp;</a></span> -->
		 <span style="margin-left: 30px"><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-lock" plain="false" onclick="javascript:$('#rt-dlr').dialog('open').dialog('center').dialog('setTitle','绑定权限');" style="height: 32px">&nbsp;绑定权限&nbsp;</a></span>
	</div>
...
<div id="rt-dlr" class="easyui-dialog" style="width:400px" closed="true" buttons="#rt-dlg-buttons" closable="false">

		<form id="rt-ffr" method="post">

			<div>
				<p>

					<label for="rightName" class="label-top">权限名称:</label> <input class="easyui-validatebox tb"
						data-options="missingMessage:'请输入权限名称.长度为3-30',tipPosition:'bottom',required:true,validateOnCreate:false,validateOnBlur:true,validType:'length[3,30]'" id="rightNamer" name="rightNamer"
						style="width: 270px" />
				</p>
			</div>
			...
			<div>
				<p>
					<label for="pid" class="label-top">所属职位：</label><input class="easyui-validatebox tb"
						data-options="missingMessage:'请输入职位名称.长度为3-30',tipPosition:'bottom',required:true,validateOnCreate:false,validateOnBlur:true,validType:'length[3,30]'" id="jobName" name="jobName"
						style="width: 270px" />
				</p>
			</div>
		</form>
   ...
   <div id="rt-dlg-buttons">
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="addRirhts()" style="width:90px">提交</a> <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
			onclick="javascript:$('#rt-ffr').form('resetValidation').form('reset');$('#rt-dlr').dialog('close');" style="width:90px">取消</a>
	</div>
