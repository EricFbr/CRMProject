		...
		<table id="cf-dg" title="客户跟踪" style="width:903px;height:250px" toolbar='#cf-toolbar'
			...
			<thead>
				<tr>
					...
					<th field="status" width="100" formatter="statuFormat" align="center"
						editor="{type:'combobox',options:{data:[{'status':'0','text':'未联系'},
				{'status':'1','text':'未接通'},
				{'status':'2','text':'紧跟'},
				{'status':'3','text':'已上门'},{'status':'4','text':'死单'},{'status':'5','text':'电话无效'}],valueField:'status',textField:'text',panelHeight:'auto'}}">跟踪状态</th>
